<template>
  ...
  <div>
    <div style="text-align: center; width: 100%; border-radius: 20px; height:fit-content; background: rgb(22, 21, 21); background: rgba(22, 21, 21, 0.5); padding: 5px; display: inline-block;">
      ...
      <p class="welcome-msg" style="color:gainsboro;">Hello My Name Is <b>Aran Jannson</b>, I am an Undergraduate Student in Computer Science going into my 2nd year at <a href="https://www.surrey.ac.uk/" style="color:antiquewhite;">The University Of Surrey</a>.</p>
